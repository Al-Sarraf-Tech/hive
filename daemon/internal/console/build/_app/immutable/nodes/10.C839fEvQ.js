import{d as zs,a as c,b as k,f as g,s as i}from"../chunks/BKzipXb4.js";import{p as Ds,c as a,f as pe,t as x,g as t,b as Rs,d as s,e as u,s as C,r as e,n,i as Ws}from"../chunks/D67c9Gwo.js";import{i as ve}from"../chunks/Cw8_URSI.js";import{e as me,i as he}from"../chunks/DhzCUvt5.js";import{s as Vs}from"../chunks/CKrvbhRz.js";import{s as Bs}from"../chunks/Dbb-5aXk.js";import{b as Ns}from"../chunks/BUgbhvgh.js";import{i as Us,a as ss}from"../chunks/DFm7loE9.js";import{g as Gs}from"../chunks/CwMx6iaP.js";var Xs=g("<a> </a>"),Ys=g('<p class="muted" style="font-size:0.8125rem">Click "Validate" to check your TOML.</p>'),qs=g('<div style="font-size:0.8125rem; color:var(--text-muted)"> </div>'),Ks=g('<div style="font-size:0.8125rem; color:var(--yellow); margin-bottom:0.25rem"> </div>'),js=g('<div style="margin-top:0.75rem"></div>'),Fs=g('<div style="display:flex; align-items:center; gap:0.5rem; margin-bottom:0.75rem"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--green)" stroke-width="2.5"><polyline points="20 6 9 17 4 12"></polyline></svg> <span class="text-green" style="font-weight:600">Valid Hivefile</span></div> <!> <!>',1),Js=g('<div style="font-size:0.8125rem; color:var(--red); margin-bottom:0.25rem; font-family:var(--mono)"> </div>'),Qs=g('<div style="display:flex; align-items:center; gap:0.5rem; margin-bottom:0.75rem"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--red)" stroke-width="2.5"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg> <span class="text-red" style="font-weight:600">Validation Failed</span></div> <!>',1),Zs=g(`<div class="page-header animate-in"><h1 class="page-title">Learn Hive</h1> <span class="muted" style="font-size:0.8125rem">Interactive guide to Hivefiles and TOML configuration</span></div> <div class="learn-layout"><nav class="learn-toc"><div class="learn-toc-title">Contents</div> <!></nav> <div><section id="what-is-hive" class="learn-section"><h2>What is Hive?</h2> <p>Hive is a <strong>container orchestrator</strong> — it deploys and manages Docker containers across multiple machines from one place.
...
memory = "128M"
cpus = 0.5
`),S=C(!1),v=C(null),l=C("");const ns=[{id:"what-is-hive",label:"What is Hive?"},{id:"how-it-works",label:"How It Works"},{id:"intro",label:"Getting Started"},{id:"clustering",label:"Clustering"},{id:"hivefile",label:"Hivefile Basics"},{id:"services",label:"Services"},{id:"env",label:"Environment & Secrets"},{id:"health",label:"Health Checks"},{id:"volumes",label:"Volumes"},{id:"resources",label:"Resources & Scaling"},{id:"deploy-strategies",label:"Deploy Strategies"},{id:"ingress",label:"Ingress & TLS"},{id:"cron",label:"Cron Jobs"},{id:"appstore",label:"App Store"},{id:"cli",label:"CLI Commands"},{id:"recipes",label:"Custom Recipes"},{id:"playground",label:"Playground"},{id:"reference",label:"Quick Reference"}];async function os(){if(!Us()){u(v,{valid:!1,errors:["Sign in to validate against the live daemon. The TOML syntax looks correct based on structure."]},!0);return}u(S,!0);try{u(v,await ss.validate(t(T),!1),!0)}catch(o){u(v,{valid:!1,errors:[o.message]},!0)}u(S,!1)}function is(){sessionStorage.setItem("hive_draft_toml",t(T)),Gs("/deploy")}function d(o,r){navigator.clipboard.writeText(r),u(l,o,!0),setTimeout(()=>{u(l,"")},2e3)}function rs(o){u(ke,o,!0);const r=document.getElementById(o);r&&r.scrollIntoView({behavior:"smooth",block:"start"})}var ue=Zs(),ge=a(pe(ue),2),H=s(ge),cs=a(s(H),2);me(cs,17,()=>ns,he,(o,r)=>{var m=Xs();let b;var _=s(m,!0);e(m),x(()=>{Vs(m,"href",`#${t(r).id??""}`),b=Bs(m,1,"",null,b,{active:t(ke)===t(r).id}),i(_,t(r).label)}),c("click",m,y=>{y.preventDefault(),rs(t(r).id)}),k(o,m)}),e(H);var ye=a(H,2),A=a(s(ye),4),L=a(s(A),8),be=s(L),I=a(s(be),2),ls=s(I,!0);e(I),e(be),n(2),e(L);var fe=a(L,6),_e=s(fe),E=a(s(_e),2),ds=s(E,!0);e(E),e(_e),n(2),e(fe),n(4),e(A);var M=a(A,2),we=a(s(M),6),xe=s(we),P=a(s(xe),2),ps=s(P,!0);e(P),e(xe),n(2),e(we),n(14),e(M);var O=a(M,2),Ce=a(s(O),4),Te=s(Ce),z=a(s(Te),2),vs=s(z,!0);e(z),e(Te),n(2),e(Ce),n(4),e(O);var D=a(O,2),Se=a(s(D),4),R=s(Se),W=a(s(R),2),ms=s(W,!0);e(W),e(R);var He=a(R,2),Ae=a(s(He),38),hs=a(s(Ae));hs.textContent={secret:db-pass},n(),e(Ae),e(He),e(Se),n(2),e(D);var V=a(D,2),B=a(s(V),2),ks=a(s(B),3);ks.textContent="{{ secret:KEY }}",n(),e(B);var Le=a(B,2),N=s(Le),U=a(s(N),2),us=s(U,!0);e(U),e(N);var Ie=a(N,2),G=a(s(Ie),8),gs=a(s(G));gs.textContent={secret:db-url},n(),e(G);var Ee=a(G,4),Me=a(s(Ee)),ys=s(Me,!0);e(Me),n(),e(Ee),e(Ie),e(Le),n(4),e(V);var X=a(V,2),Pe=a(s(X),6),Oe=s(Pe),Y=a(s(Oe),2),bs=s(Y,!0);e(Y),e(Oe),n(2),e(Pe),e(X);var q=a(X,2),ze=a(s(q),4),De=s(ze),K=a(s(De),2),fs=s(K,!0);e(K),e(De),n(2),e(ze),n(2),e(q);var j=a(q,2),Re=a(s(j),4),We=s(Re),F=a(s(We),2),_s=s(F,!0);e(F),e(We),n(2),e(Re),n(2),e(j);var J=a(j,2),Ve=a(s(J),6),Be=s(Ve),Q=a(s(Be),2),ws=s(Q,!0);e(Q),e(Be),n(2),e(Ve),e(J);var Z=a(J,2),Ne=a(s(Z),4),Ue=s(Ne),$=a(s(Ue),2),xs=s($,!0);e($),e(Ue),n(2),e(Ne),n(2),e(Z);var ee=a(Z,2),Ge=a(s(ee),4),Xe=s(Ge),se=a(s(Xe),2),Cs=s(se,!0);e(se),e(Xe),n(2),e(Ge),n(2),e(ee);var ae=a(ee,2),Ye=a(s(ae),6),qe=s(Ye),te=a(s(qe),2),Ts=s(te,!0);e(te),e(qe),n(2),e(Ye),n(8),e(ae);var ne=a(ae,4),Ke=a(s(ne),4),oe=s(Ke),ie=a(s(oe),2),Ss=s(ie,!0);e(ie),e(oe);var je=a(oe,2),Fe=a(s(je),70),Hs=a(s(Fe));Hs.textContent={config:api_key},n(),e(Fe),e(je),e(Ke),n(2),e(ne);var Je=a(ne,2),Qe=a(s(Je),4),re=s(Qe),ce=s(re),Ze=a(s(ce),2),f=s(Ze),As=s(f,!0);e(f);var Ls=a(f,2);e(Ze),e(ce);var $e=a(ce,2);Ws($e),e(re);var es=a(re,2),Is=a(s(es),2);{var Es=o=>{var r=Ys();k(o,r)},Ms=o=>{var r=Fs(),m=a(pe(r),2);{var b=h=>{var p=qs(),le=s(p);e(p),x(w=>i(le,`Services found: ${w??""}`),[()=>t(v).services.map(w=>w.name).join(", ")]),k(h,p)};ve(m,h=>{var p;(p=t(v).services)!=null&&p.length&&h(b)})}var _=a(m,2);{var y=h=>{var p=js();me(p,21,()=>t(v).warnings,he,(le,w)=>{var de=Ks(),Os=s(de);e(de),x(()=>i(Os,`⚠ ${t(w)??""}`)),k(le,de)}),e(p),k(h,p)};ve(_,h=>{var p;(p=t(v).warnings)!=null&&p.length&&h(y)})}k(o,r)},Ps=o=>{var r=Qs(),m=a(pe(r),2);me(m,17,()=>t(v).errors||[t(v).error||"Unknown error"],he,(b,_)=>{var y=Js(),h=s(y,!0);e(y),x(()=>i(h,t(_))),k(b,y)}),k(o,r)};ve(Is,o=>{t(v)===null?o(Es):t(v).valid?o(Ms,1):o(Ps,-1)})}e(es),e(Qe),e(Je),n(2),e(ye),e(ge),x(()=>{i(ls,t(l)==="install"?"Copied!":"Copy"),i(ds,t(l)==="start"?"Copied!":"Copy"),i(ps,t(l)==="cluster"?"Copied!":"Copy"),i(vs,t(l)==="basic"?"Copied!":"Copy"),i(ms,t(l)==="multi"?"Copied!":"Copy"),i(us,t(l)==="env"?"Copied!":"Copy"),i(ys,{secret:ss-key}),i(bs,t(l)==="health"?"Copied!":"Copy"),i(fs,t(l)==="vol"?"Copied!":"Copy"),i(_s,t(l)==="res"?"Copied!":"Copy"),i(ws,t(l)==="deploy"?"Copied!":"Copy"),i(xs,t(l)==="ingress"?"Copied!":"Copy"),i(Cs,t(l)==="cron"?"Copied!":"Copy"),i(Ts,t(l)==="appstore-cmds"?"Copied!":"Copy"),i(Ss,t(l)==="recipe"?"Copied!":"Copy"),f.disabled=t(S),i(As,t(S)?"Validating...":"Validate")}),c("click",I,()=>d("install","curl -fsSL https://raw.githubusercontent.com/Al-Sarraf-Tech/hive/main/install.sh | bash")),c("click",E,()=>d("start","hive setup")),c("click",P,()=>d("cluster",`# On the first node:
hive init --name my-cluster
...
[service.my-app.env]
API_KEY = "{{ config:api_key }}"`)),c("click",f,os),c("click",Ls,is),Ns($e,()=>t(T),o=>u(T,o)),k(as,ue),Rs()}zs(["click"]);export{ca as component};
